  ...
  return (
    <header className="h-full bg-white border-b border-gray-100">
      <div className="h-full flex items-center justify-between px-4">
        <Link to="/" className="text-xl font-bold text-blue-600" style={{ fontFamily: 'Pacifico, serif' }}>
          logo
        </Link>
        ...
        <div className="flex items-center space-x-3">
          ...
          <button className="w-10 h-10 flex items-center justify-center rounded-full bg-gray-50 hover:bg-gray-100 transition-colors relative">
