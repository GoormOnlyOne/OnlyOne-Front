        ...
        <div className="space-y-6">
          ...
          <div className="mb-4">
            <label className="block text-sm font-medium text-gray-700 mb-2">
              <span className="text-red-400 mr-1">*</span>사진 등록 (
              {totalImages}/5)
              <p className="text-xs text-gray-500 mt-1">최소 1개 이상 필수</p>
            </label>

            {/* 5개 슬롯 그리드 */}
            <div className="grid grid-cols-3 gap-3 p-4 bg-brand-primary/5 rounded-lg border-1 border-gray-300">
              {/* 첫 번째 줄: 3개 슬롯 */}
              {[0, 1, 2].map(index => (
                  ...
                  {imagePreviews[index] ? (
                    <div className="relative w-full h-full">
                      ...
                      <button
                        ...
                        className="absolute -top-2 -right-2 w-6 h-6 bg-brand-primary text-white rounded-full text-xs font-bold hover:bg-red-600"
                        type="button"
                      >
                        ×
                      </button>
                    ...
                    <div
                      ...
                      className="w-full h-full bg-white border-1 border-gray-300 rounded-lg flex items-center justify-center cursor-pointer hover:bg-gray-100 transition-colors"
                    >
