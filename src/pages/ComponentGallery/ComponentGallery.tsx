...
import ChatRoomList, {
  type ChatRoom,
} from '../../components/domain/chat/ChatRoomList';
...
export const ComponentGallery = () => {
  ...
  return (
    <div>
      ...
      <ParticipantInfo nickname="김철수" profileImage={null} />
      <ParticipantInfo nickname="이영희" profileImage={DefaultImage} />
      <ParticipantInfo nickname="박민수" profileImage={null} />
